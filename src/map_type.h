...
typedef map<int, int> mapword2id; //TODO: Deze weghalen

// map of words/terms [int => string]
typedef map<int, string> mapid2word; //TODO: Deze weghalen

// map of words/attributes_of_words [string => word_attr]
typedef map<int, Word_atr> mapword2atr;

// map of word / word prior info [string => sentiment lab ID, sentiment label distribition]
typedef map<int, Word_Prior_Attr > mapword2prior;

// map of doc / doc label distribution [string => doc label distribition]
typedef map<int, vector<double> > mapname2labs;
